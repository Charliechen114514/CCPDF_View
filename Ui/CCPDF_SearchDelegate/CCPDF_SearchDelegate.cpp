...
#include "CCPDF_SearchDelegate.h"

CCPDF_SearchDelegate::CCPDF_SearchDelegate(QObject *parent)
  : QStyledItemDelegate(parent)
{
}

void CCPDF_SearchDelegate::paint(QPainter *painter, const QStyleOptionViewItem &option,
